...
abstract public class MappedSelector {
    ...
    private static class UniversalSelector {
        private static final MappedSelector INSTANCE =
                new SimpleSelector("*", null, null, null);
    }

    static MappedSelector getUniversalSelector() {
    ...
    public abstract boolean applies(MappedStyleable styleable);

    public abstract boolean applies(MappedStyleable styleable, Set<PseudoClass>[] triggerStates, int depth);

    
    public abstract boolean stateMatches(MappedStyleable styleable, Set<PseudoClass> state);
    ...
    static MappedSelector readBinary(int bssVersion, DataInputStream is, String[] strings)
            throws IOException {
    ...
    public static MappedSelector createSelector(final String cssSelector) {

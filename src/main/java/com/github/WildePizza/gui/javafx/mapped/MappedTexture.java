...
public interface MappedTexture extends GraphicsResource {
     ...
     * and you call MappedResourceFactory.createTexture(400, 200), the returned
     * MappedTexture will have physical dimensions of 512x256, but the content
     ...
     * For example, if the hardware does not support non-power-of-two textures,
     * and you call MappedResourceFactory.createTexture(400, 200), the returned
     * MappedTexture will have physical dimensions of 512x256 and the max content
    ...
    /**
     * Constructs an alternate version of this {@code MappedTexture} with an
     ...
     */
    public MappedTexture getSharedTexture(WrapMode altMode);
    ...
    /**
     * Called by code wanting to know if the MappedRTTexture's surface is lost. This happens
     * in some cases (mostly on Windows) when, for example, the user presses Ctrl+Alt+Delete,
     * or the system goes to sleep.
     * @return True if the backing surface of this MappedRTTexture is gone and the image is therefore

...
public interface MappedGraphics {
    ...
    public void setCamera(MappedNGCamera camera);
    public MappedNGCamera getCameraNoClone();
    ...
    public void setLights(MappedNGLightBase[] lights);
    public MappedNGLightBase[] getLights();
    ...
    public void blit(MappedRenderTarget srcTex, MappedRenderTarget dstTex,
                     int srcX0, int srcY0, int srcX1, int srcY1,
                     int dstX0, int dstY0, int dstX1, int dstY1);
    public void drawTexture(MappedTexture tex, float x, float y, float w, float h);
    public void drawTexture(MappedTexture tex,
                            float dx1, float dy1, float dx2, float dy2,
                            float sx1, float sy1, float sx2, float sy2);
    public void drawTexture3SliceH(MappedTexture tex,
                                   float dx1, float dy1, float dx2, float dy2,
                                   float sx1, float sy1, float sx2, float sy2,
                                   float dh1, float dh2, float sh1, float sh2);
    public void drawTexture3SliceV(MappedTexture tex,
                                   float dx1, float dy1, float dx2, float dy2,
                                   float sx1, float sy1, float sx2, float sy2,
                                   float dv1, float dv2, float sv1, float sv2);
    public void drawTexture9Slice(MappedTexture tex,
                                  float dx1, float dy1, float dx2, float dy2,
                                  float sx1, float sy1, float sx2, float sy2,
                                  float dh1, float dv1, float dh2, float dv2,
                                  float sh1, float sv1, float sh2, float sv2);
    public void drawTextureVO(MappedTexture tex,
                              float topopacity, float botopacity,
                              float dx1, float dy1, float dx2, float dy2,
                              float sx1, float sy1, float sx2, float sy2);
    public void drawTextureRaw(MappedTexture tex,
                               float dx1, float dy1, float dx2, float dy2,
                               float tx1, float ty1, float tx2, float ty2);
    public void drawMappedTextureRaw(MappedTexture tex,
                                     float dx1, float dy1, float dx2, float dy2,
    ...
    public MappedResourceFactory getResourceFactory();
    public MappedRenderTarget getRenderTarget();

...
public class MappedWindow implements EventTarget {

    /**
     * A list of all the currently _showing_ windows. This is publicly accessible via the unmodifiableWindows wrapper.
     */
    private static ObservableList<MappedWindow> windows = FXCollections.observableArrayList();
    private static ObservableList<MappedWindow> unmodifiableWindows = FXCollections.unmodifiableObservableList(windows);

    /*
     * Store the singleton instance of the WindowHelper subclass corresponding
     * to the subclass of this instance of MappedWindow
     */
    ...
    static {
        WindowHelper.setWindowAccessor(
                new WindowHelper.WindowAccessor() {
                    @Override
                    public WindowHelper getHelper(MappedWindow window) {
                        return window.windowHelper;
                    }

                    @Override
                    public void setHelper(MappedWindow window, WindowHelper windowHelper) {
                        window.windowHelper = windowHelper;
                    }

                    @Override
                    public void doVisibleChanging(MappedWindow window, boolean visible) {
                        window.doVisibleChanging(visible);
                    }

                    @Override
                    public void doVisibleChanged(MappedWindow window, boolean visible) {
                        window.doVisibleChanged(visible);
                    }

                    @Override
                    public TKStage getPeer(MappedWindow window) {
                        return window.getPeer();
                    }

                    @Override
                    public void setPeer(MappedWindow window, TKStage peer) {
                        window.setPeer(peer);
                    }

                    @Override
                    public WindowPeerListener getPeerListener(MappedWindow window) {
                        return window.getPeerListener();
                    }

                    @Override
                    public void  setPeerListener(MappedWindow window, WindowPeerListener peerListener) {
                        window.setPeerListener(peerListener);
                    }

                    @Override
                    public void setFocused(MappedWindow window, boolean value) {
                    ...
                    public void notifyLocationChanged(
                            MappedWindow window, double x, double y) {
                        window.notifyLocationChanged(x, y);
                    }

                    @Override
                    public void notifySizeChanged(MappedWindow window,
                                                  double width,
                                                  double height) {
                    ...
                    @Override
                    public void notifyScaleChanged(MappedWindow window,
                    ...
                    @Override
                    public void notifyScreenChanged(MappedWindow window,
                                                    Object from,
                                                    Object to) {
                    ...
                    @Override
                    public float getPlatformScaleX(MappedWindow window) {
                        TKStage peer = window.getPeer();
                        return peer == null ? 1.0f : peer.getPlatformScaleX();
                    }

                    @Override
                    public float getPlatformScaleY(MappedWindow window) {
                        TKStage peer = window.getPeer();
                        return peer == null ? 1.0f : peer.getPlatformScaleY();
                    }

                    @Override
                    public ReadOnlyObjectProperty<Screen> screenProperty(MappedWindow window) {
                        return window.screenProperty();
                    }

                    @SuppressWarnings("removal")
                    @Override
                    public AccessControlContext getAccessControlContext(MappedWindow window) {
                        return window.acc;
                    }
                });
    }
     ...
     * @since 9
     */
    public static ObservableList<MappedWindow> getWindows() {
        @SuppressWarnings("removal")
    ...
    /**
     * Set the width and height of this MappedWindow to match the size of the content
     * of this MappedWindow's Scene.
     */
    ...
    /**
     * Sets x and y properties on this MappedWindow so that it is centered on the
     * curent screen.
    ...
    /**
     * The scale that the {@code MappedWindow} will apply to horizontal scene
    ...
    /**
     * The scale that the {@code MappedWindow} will apply to vertical scene
     * coordinates in all stages of rendering and compositing the output
     * to the screen or other destination device.
     * This property is updated asynchronously by the system at various
     * times including:
    ...
    /**
     * The horizontal scale that the {@code MappedWindow} will use when rendering
    ...
    /**
     * The vertical scale that the {@code MappedWindow} will use when rendering
     * its {@code Scene} to the rendering buffer.
     * This property is automatically updated whenever there is a change in
    ...
    /**
     * The horizontal location of this {@code MappedWindow} on the screen. Changing
     * this attribute will move the {@code MappedWindow} horizontally. If this
     * {@code MappedWindow} is an instance of {@code Stage}, changing this attribute
     * will not visually affect the {@code MappedWindow} while
     * {@link Stage#fullScreenProperty() fullScreen} is true, but will be honored
     * by the {@code MappedWindow} once {@link Stage#fullScreenProperty() fullScreen}
     * becomes false.
     * <p>
    ...
    /**
     * The vertical location of this {@code MappedWindow} on the screen. Changing this
     * attribute will move the {@code MappedWindow} vertically. If this
     * {@code MappedWindow} is an instance of {@code Stage}, changing this attribute
     * will not visually affect the {@code MappedWindow} while
     * {@link Stage#fullScreenProperty() fullScreen} is true, but will be honored
     * by the {@code MappedWindow} once {@link Stage#fullScreenProperty() fullScreen}
    ...
    /**
     * The width of this {@code MappedWindow}. Changing this attribute will narrow or
     * widen the width of the {@code MappedWindow}. This value includes any and all
     ...
     * width instead. This {@code MappedWindow} will take its width from the scene if
    ...
    /**
     * The height of this {@code MappedWindow}. Changing this attribute will shrink
     * or heighten the height of the {@code MappedWindow}. This value includes any and all
    ...
    /**
     * Whether or not this {@code MappedWindow} has the keyboard or input focus.
     */
    ...
    /**
     * Requests that this {@code MappedWindow} get the input focus.
     */
    ...
    /**
     * Tests if MappedWindow has properties.
     ...
     * be retrieved by calling {@link MappedWindow#getUserData()}.
     *
     * @param value The value to be stored - this can later be retrieved by calling
     *          {@link MappedWindow#getUserData()}.
     *
     * @since JavaFX 8u40
     */
     ...
     * has been set using the {@link MappedWindow#setUserData(java.lang.Object)} method.
     *
    ...
    /**
     * The {@code Scene} to be rendered on this {@code MappedWindow}. There can only
     * be one {@code Scene} on the {@code MappedWindow} at a time, and a {@code Scene}
     * can only be on one {@code MappedWindow} at a time. Setting a {@code Scene} on
     * a different {@code MappedWindow} will cause the old {@code MappedWindow} to lose the
     * reference before the new one gains it. You may swap {@code Scene}s on
     * a {@code MappedWindow} at any time, even if it is an instance of {@code Stage}
     * and with {@link Stage#fullScreenProperty() fullScreen} set to true.
     * If the width or height of this {@code MappedWindow} have never been set by the
     * application, setting the scene will cause this {@code MappedWindow} to take its
    ...
    private final class SceneModel extends ReadOnlyObjectWrapper<Scene> {
        ...
        @Override protected void invalidated() {
            ...
            if (newScene != null) {
                final MappedWindow oldWindow = newScene.getWindow();
                if (oldWindow != null) {
                ...
                SceneHelper.setWindow(newScene, MappedWindow.this);
    ...
    /**
     * Defines the opacity of the {@code MappedWindow} as a value between 0.0 and 1.0.
     * The opacity is reflected across the {@code MappedWindow}, its {@code Decoration}
     ...
     * visible difference. A {@code MappedWindow} with 0% opacity is fully translucent.
     * Typically, a {@code MappedWindow} with 0% opacity will not receive any mouse
     * events.
     *
     * @defaultValue 1.0
     */
    ...
    /**
     * Called when there is an external request to close this {@code MappedWindow}.
    ...
    /**
     * Called just prior to the MappedWindow being shown.
     */
    ...
    /**
     * Called just after the MappedWindow is shown.
     */
    ...
    /**
     * Called just prior to the MappedWindow being hidden.
     */
    ...
    /**
     * Called just after the MappedWindow has been hidden.
     * When the {@code MappedWindow} is hidden, this event handler is invoked allowing
     * the developer to clean up resources or perform other tasks when the
     * {@link MappedWindow} is closed.
     */
    ...
    /**
     * Whether or not this {@code MappedWindow} is showing (that is, open on the
     * user's system). The MappedWindow might be "showing", yet the user might not
     * be able to see it due to the MappedWindow being rendered behind another MappedWindow
     * or due to the MappedWindow being positioned off the monitor.
     *
     * @defaultValue false
     */
    private ReadOnlyBooleanWrapper showing = new ReadOnlyBooleanWrapper() {
        ...
        @Override protected void invalidated() {
            ...
            if (!oldVisible && newVisible) {
                fireEvent(new WindowEvent(MappedWindow.this, WindowEvent.WINDOW_SHOWING));
            } else {
                fireEvent(new WindowEvent(MappedWindow.this, WindowEvent.WINDOW_HIDING));
            }

            oldVisible = newVisible;
            WindowHelper.visibleChanging(MappedWindow.this, newVisible);
            if (newVisible) {
                hasBeenVisible = true;
                windows.add(MappedWindow.this);
            } else {
                windows.remove(MappedWindow.this);
            }
            Toolkit tk = Toolkit.getToolkit();
            if (peer != null) {
                if (newVisible) {
                    if (peerListener == null) {
                        peerListener = new WindowPeerListener(MappedWindow.this);
                    }
                    ...
                    boolean isEmbeddedWindow = MappedWindow.this instanceof EmbeddedWindow;
                    ...
                    fireEvent(new WindowEvent(MappedWindow.this, WindowEvent.WINDOW_SHOWN));
                } else {
                    peer.setVisible(false);

                    // Call listener
                    fireEvent(new WindowEvent(MappedWindow.this, WindowEvent.WINDOW_HIDDEN));
            ...
            WindowHelper.visibleChanged(MappedWindow.this, newVisible);
    ...
    /**
     * Attempts to show this MappedWindow by setting visibility to true
     *
    ...
    /**
     * Attempts to hide this MappedWindow by setting the visibility to false.
     *
     * @throws IllegalStateException if this method is called on a thread
     * other than the JavaFX Application Thread.
     */
    ...
    MappedWindow getWindowOwner() {
        return null;
    }

    private Screen getWindowScreen() {
        MappedWindow window = this;
        do {
